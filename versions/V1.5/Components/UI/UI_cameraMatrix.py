...
class Ui_createCamMatrixDialog(object):
    def setupUi(self, createCamMatrixDialog):
        ...
        createCamMatrixDialog.setWindowIcon(QIcon('Components/UI/Icons/app_create.png'))
    ...
    def retranslateUi(self, createCamMatrixDialog):
        ...
        self.camMatPicDirLabel.setText(_translate("createCamMatrixDialog", "Please import at least 10 photos "
                                                                           "shot\nusing the same camera with "
                                                                           "different angle.\nEach photo should "
                                                                           "contain one and the same chessboard."))
