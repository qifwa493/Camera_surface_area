...
class Ui_settingsDialog(object):
    def setupUi(self, settingsDialog):
        ...
        settingsDialog.setWindowIcon(QIcon('Components/UI/Icons/app_settings.png'))
        ...
        self.unitSizeSlider.setMinimum(20)
        self.unitSizeSlider.setMaximum(30)
        self.unitSizeSlider.setSliderPosition(25)
        ...
        self.unitSizeSpinBox.setMinimum(20)
        self.unitSizeSpinBox.setMaximum(30)
        self.unitSizeSpinBox.setProperty("value", 25)
    ...
    def retranslateUi(self, settingsDialog):
        ...
        self.unitSizeGroup.setTitle(_translate("settingsDialog", "Chessboard Unit size (mm)"))
